# backend/telemetry/interface.py
...
class TelemetryConfig:
    ...
    def __init__(self, enabled: bool = True):
        ...
        self.scraping_counter = self._provider.create_counter(
            "scraping_jobs_total",
            "Total scraping jobs executed"
        )
        self.meal_plan_counter = self._provider.create_counter(
            "meal_plans_generated_total",
            "Total meal plans generated"
        )
        self.store_discovery_time = self._provider.create_histogram(
            "store_discovery_time_seconds",
            "Store discovery time in seconds"
        )
        self.offers_scraped_counter = self._provider.create_counter(
            "offers_scraped_total",
            "Total offers scraped from stores"
        )
